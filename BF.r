...
BF5=round(BF(B,C,n,x),4)
BF6=round(BF(B,C,n,z),4)

BF7=round(BF(A,D,n,x),4)
BF8=round(BF(A,D,n,z),4)
t2<-data.frame(c1=c(BF1,BF2), c2=c(BF3, BF4),c3=c(BF5,BF6), c4=c(BF7, BF8), row.names=c("(0,1,2,3,4)", "(0,0,1,4,5)"));t2
rm(list=ls())
